...
class MotivationalPodcastsVC: UIViewController {
    ...
    @IBOutlet weak var podcastTitleLabel: UILabel! {
        didSet {
            ...
            podcastTitleLabel.text = Lang.get(valueFor: .l_podcasts_motivational)
        }
    }
...
extension MotivationalPodcastsVC: UICollectionViewDelegate {
    
}

extension MotivationalPodcastsVC: UICollectionViewDelegateFlowLayout {
...
extension MotivationalPodcastsVC: UICollectionViewDataSource {
