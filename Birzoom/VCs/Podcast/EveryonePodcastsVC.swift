...
class EveryonePodcastsVC: UIViewController {
    ...
    @IBOutlet weak var podcastTitleLabel: UILabel! {
        didSet {
            ...
            podcastTitleLabel.text = Lang.get(valueFor: .l_podcasts_forEveryone)
        }
    }
...
extension EveryonePodcastsVC: UICollectionViewDelegate {
    
}

extension EveryonePodcastsVC: UICollectionViewDelegateFlowLayout {
...
extension EveryonePodcastsVC: UICollectionViewDataSource {
